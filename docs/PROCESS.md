...
| `PUBLIC_STRIPE_PAYMENT_URL` | `data/payments.ts`, `RegisterSection.astro:80` |
| `PUBLIC_STRIPE_LINK_HCA_BLENDED` / `_CORE_BASIC` / `_CPR` / `_CE` / `_ND_CORE` / `_ND_DIABETES` | `data/payments.ts` |
